                        ...
                        <div className="ibox-content">
                            ...
                            <div className="clients-list">
                                <ul className="nav nav-tabs">
                                    ...
                                    <li className=""><a data-toggle="tab" href="#tab-2"><i className="fa fa-briefcase"></i> Companies</a></li>
                                </ul>
