    ...
    render() {
        return (
            <div className="wrapper wrapper-content animated fadeInRight">
                ...
                <div className="row"><Graphs config={{ type: 'bar', title: 'Dashboard Chart' }}/></div>
                <div className="row">
                                ...
                                <div className="ibox float-e-margins">
                                    ...
                                    <div className="ibox-content">
                                        <ul className="todo-list m-t small-list">
                                            <li>
                                                <a  className="check-link"><i className="fa fa-check-square"></i> </a>
                                                <span className="m-l-xs todo-completed">Buy a milk</span>

                                            </li>
                                            <li>
                                                <a  className="check-link"><i className="fa fa-square-o"></i> </a>
